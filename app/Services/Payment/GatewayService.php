...
use App\Services\Payment\Gateways\GamePixService;
use App\Services\Payment\Gateways\SuitPayService;
...
class GatewayService
{
    ...
    public function validateReturn($request)
    {
        ...
        return (new $serviceClass($this->gateway))->validateReturn($request);
    }
    ...
    private function getGatewayClass(string $gatewayType): string|bool
    {
        return match ($gatewayType) {
            ...
            GatewayType::SuitPay->value => SuitPayService::class,
            GatewayType::GamePix->value => GamePixService::class,
            default => 'false'
        };
    }
