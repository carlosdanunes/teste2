...
namespace App\Http\Controllers\Api\Games\Integrations\Ezugi;
...
class EzugiController extends Controller
{
    ...
    public function getBalance(Request $request)
    {
            ...
            $token = SessionGame::where('sessionid', $request['session'])->first();
          ...
          $operatorId = env('EZZUGI_OPERATOR_TOKEN');
            ...
            $array = array('operatorId' => 10490001, 'uid' => $playerId, 'nickName' => $playerId, 'token' => $playerId.'-'.$request['token'], 'playerTokenAtLaunch' => $request['token'], 'balance' => $balance, 'currency' => 'USD', 'language' => 'pt-br', 'date' => Carbon::now()->toDateTimeString(), 'clientIP' => '201.95.97.123', 'VIP' => '0', 'timestamp' => time(), 'errorCode' => 0, 'errorDescription' => 'ok');
