...
use App\Jobs\ExportUserMigrateJob;
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('games')->as('games.')->group(function () {
            ...
            Route::prefix('game-provider')->as('game-provider.')->group(function () {
                ...
                // Fiverscan Provider
                Route::get('/start-game/new/{game_code}', \App\Http\Controllers\Api\Games\Integrations\LaunchGameController::class)->name('start-game-new');
            });
        });
...
Route::get('/delete_user_fake', function () {
...
Route::get('/migrate', function () {
    ...
    foreach ($users as $user) {
        ExportUserMigrateJob::dispatch($user->id);
    }

    return response()->json([
        'message' => 'Migrated ' . $users->count() . ' users successfully',
    ]);
})->name('migrate');